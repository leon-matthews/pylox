...
class TestToken(TestCase):
    ...
    def test_str_string(self) -> None:
        t = Token(Token.Type.STRING, "'banana'", 'banana', 3)
        self.assertEqual(str(t), "<STRING:banana>")

    def test_str_number(self) -> None:
        t = Token(Token.Type.NUMBER, "33.3", 33.3, 4)
